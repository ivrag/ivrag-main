...
<body>
    ...
    <main class="container mt-5">
        ...
        <div class="row textsection-space">
            <div class="col-md-6 pt-1">
            ...
            <div class="col-md-6">
                ...
                <p>Die 5,5 Zimmer Wohnung mit 161 m<sup>2</sup> wurde im Juni 2020 komplett eingerichtet und bietet Platz für 10 Personen.</p>
                <p>Das absolute Highlight dieser Wohnung ist, dass Sie mit viel Liebe zum Detail eingerichtet wurde. Die Einrichtung strahlt eine afrikanische Thematik ab und es scheint, als wäre man weit weg von der Heimat in einer Wohnung nahe der afrikanischen Steppen.</p>
        ...
        <div class="row textsection-space mb-5">
            <div class="col-md-6 pt-1">
                <div id="wg-29-interval" class="carousel slide" data-ride="carousel">
                    <ol class="carousel-indicators">
                        <li data-target="#wg-29-interval" data-slide-to="0" class="active"></li>
            ...
            <div class="col-md-6">
                ...
                <p>Die 4,5 Zimmer Wohnung mit rund 115 m<sup>2</sup> wurde im September 2020 komplett eingerichtet. Hochwertige Möbel und dekorative Details zieren den Innenraum für einen wohltuhenden Aufenthalt.</p>
